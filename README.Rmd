...
If you are using `pak` and it fails (currently `pak` may have issues building from source on some setups), try installing from `r-universe` using the standard `remotes` or `devtools` approach:
