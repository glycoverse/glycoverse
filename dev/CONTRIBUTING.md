...
This outlines how to propose a change to glycoverse. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glycoverse", fork = TRUE)`.
...
Please note that the glycoverse project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glycoverse/dev/CODE_OF_CONDUCT.md).
